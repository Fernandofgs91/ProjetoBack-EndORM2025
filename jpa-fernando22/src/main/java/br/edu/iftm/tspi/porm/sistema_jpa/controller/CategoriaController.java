...
public class CategoriaController {
    ...
    @GetMapping("/quantidade-produtos-nativo")
    public ResponseEntity<List<CategoriaQuantidadeDTO>> buscarCategoriasQuantidadeNativo() {
        return ResponseEntity.ok(repository.contarProdutosPorCategoriaNativo());
    }

    @GetMapping("/quantidade-produtos/{id}")
    public ResponseEntity<CategoriaQuantidadeDTO> buscarCategoriasQuantidadeEspecifica
            (@PathVariable Integer id) {
        return ResponseEntity.ok(repository.contarProdutoPorCategoria(id));
    }
}
